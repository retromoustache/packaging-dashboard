      ...
      <div className={`${getModalClasses()} rounded-xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl`}>
        <div className={`flex items-center justify-between p-4 border-b ${getBorderClasses()}`}>
          <h2 className={`text-xl font-bold ${getTextClasses('primary')} flex items-center gap-2`}>
            ...
            {initialScript ? 'Edit File' : 'Add New File'}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="space-y-2">
            ...
            <input type="text" id="scriptName" name="name" value={script.name} onChange={handleInputChange} className={`w-full ${getInputClasses()} rounded-lg px-3 py-2 ${getTextClasses('input')} focus:outline-none`} placeholder="e.g., Pre-Installation Script.ps1" disabled={isSubmitting} />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <textarea id="scriptContent" name="content" value={script.content} onChange={handleInputChange} className={`w-full h-64 font-mono text-sm ${getBgClasses('code')} border ${getBorderClasses()} rounded-lg px-3 py-2 ${getTextClasses('code')} focus:outline-none focus:ring-2 focus:ring-blue-500/50`} placeholder="Paste your file content here..." disabled={isSubmitting} spellCheck="false" />
